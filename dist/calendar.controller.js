...
export var CalendarController = (function () {
    ...
    CalendarController.prototype.openCalendar = function (calendarOptions, modalOptions) {
        ...
        var _arr = [];
        var _a = calendarOptions || {}, _b = _a.from, from = _b === void 0 ? new Date() : _b, _c = _a.to, to = _c === void 0 ? 0 : _c, _d = _a.cssClass, cssClass = _d === void 0 ? '' : _d, _e = _a.weekStartDay, weekStartDay = _e === void 0 ? 0 : _e, _f = _a.isRadio, isRadio = _f === void 0 ? true : _f, _g = _a.canBackwardsSelected, canBackwardsSelected = _g === void 0 ? false : _g, _h = _a.disableWeekdays, disableWeekdays = _h === void 0 ? _arr : _h, _j = _a.closeLabel, closeLabel = _j === void 0 ? 'cancel' : _j, _k = _a.id, id = _k === void 0 ? 0 : _k, _l = _a.isSaveHistory, isSaveHistory = _l === void 0 ? false : _l, _m = _a.monthTitle, monthTitle = _m === void 0 ? 'MMM yyyy' : _m, _o = _a.title, title = _o === void 0 ? 'Calendar' : _o, _p = _a.weekdaysTitle, weekdaysTitle = _p === void 0 ? "Di_Lu_Ma_Me_Je_Ve_Sa".split("_") : _p, _q = _a.daysConfig, daysConfig = _q === void 0 ? _arr : _q, _r = _a.countNextMonths, countNextMonths = _r === void 0 ? 3 : _r;
        var options = {
            from: from,
            to: to,
            cssClass: cssClass,
