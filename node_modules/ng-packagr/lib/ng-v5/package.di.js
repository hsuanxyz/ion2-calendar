...
const analyse_sources_di_1 = require("./init/analyse-sources.di");
...
exports.PACKAGE_TRANSFORM = transform_di_1.provideTransform({
    ...
    deps: [project_di_1.PROJECT_TOKEN, init_tsconfig_di_1.INIT_TS_CONFIG_TOKEN, analyse_sources_di_1.ANALYSE_SOURCES_TOKEN, entry_point_di_1.ENTRY_POINT_TRANSFORM_TOKEN]
});
